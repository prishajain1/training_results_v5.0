...
def convert_igbh_dataset(
    ...
    if not os.path.exists(feature_dir):
        print('creating convert dir {}'.format(feature_dir, ))
        os.makedirs(feature_dir)

    if not os.path.exists(graph_dir):
        print("creating graph storage copy dir {}".format(graph_dir, ))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--convert_feature_dir', type=str, default='/converted',
                        help='output dir containing converted features')
    parser.add_argument('--convert_graph_dir', type=str, default='/graph',
                        help="output dir containing converted graph structures")
    ...
    convert_igbh_dataset(
        ...
        feature_dir=f"{system_args.convert_feature_dir}/{system_args.size}/{system_args.precision}",
        ...
        graph_dir=f"{system_args.convert_graph_dir}/{system_args.size}"
    )
