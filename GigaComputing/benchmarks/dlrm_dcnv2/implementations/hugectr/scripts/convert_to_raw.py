...
class DataConverter:
    ...
    def save(self):
        ...
        with open(self.output_file, "wb", buffering=self.buffer_size) as out:
            ...
            for day in self.days:
                ...
                while start < len(label):
                    ...
                    sparse = np.concatenate([sparse_feat[start:end] for sparse_feat in sparse_list], axis=1)
        ...
        self.logger.info(f"Total number of samples done for stage = {self.stage}: {samples_total:,}")
