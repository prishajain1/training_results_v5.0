...
def generate_plan(
    ...
    if args.sharding_plan in ["round_robin", "uniform"]:
        ...
        if args.sharding_plan == "auto":
            ...
            planner = Planner(multi_hot_sizes, num_gpus, cost_model, log_result=log_result, dp_threshold=args.dp_sharding_threshold)
            ...
            planner = Planner(multi_hot_sizes, num_nodes, cost_model, log_result=log_result, dp_threshold=args.dp_sharding_threshold)
