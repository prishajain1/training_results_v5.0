...
export GET_MOUNT_INFO=1
export MLPERF_SCALE=2
export MLPERF_CLUSTER_NAME=HPE
...
export SHARD_WALLTIME=60 # measured: Sharding time from repo is 60 minutes per node
export WALLTIME_RUNANDTIME=30  # measured: run_and_time.sh takes up to 20 minutes
export WALLTIME=$((10 + ${NEXP:-1} * ($WALLTIME_RUNANDTIME + 5) + $SHARD_WALLTIME))
